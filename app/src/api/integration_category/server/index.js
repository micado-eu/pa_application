...
export default {
  fetchIntegrationCategory () {
    return axiosInstance
      .get('/intervention-categories?filter[include][0][relation]=translations&filter[include][1][relation]=linkedInterventionType')
    ...
    updateIntegrationCategory (integration_category) {
      ...
      return axiosInstance
        .patch('/intervention-categories?where=' + JSON.stringify(whereClause), updatingCategory)
    ...
    updateIntegrationCategoryTranslation (translation) {
      ...
      return axiosInstance
        .patch('/intervention-categories/' + translation.id + '/intervention-category-translations?where=' + JSON.stringify(whereClause), updatingTranslation)
        .then(response => response.data)
        .catch(error_handler)
    },
    ...
    saveIntegrationCategory (integration_category) {
      // create fake id here
      return axiosInstance
      .post('/intervention-categories', integration_category)
      .then(response => response.data)
      .catch(error_handler)
    },
    saveIntegrationCategoryTranslation (translation, id) {
      ...
      // create fake id here
      return axiosInstance
        .post('/intervention-categories/' + id + '/intervention-category-translations', savingTranslation)
        .then(response => response.data)
        .catch(error_handler)
    },
    deleteIntegrationCategoryTranslations (id) {
      return axiosInstance
        .delete('/intervention-categories/' + id + '/intervention-category-translations')
        .then(response => response.data)
        .catch(error_handler)
    },
    ...
    deleteIntegrationCategory (id) {
      return axiosInstance
        .delete('/intervention-categories/' + id)
        .then(response => response.data)
        .catch(error_handler)
    },
    updatePublished(id, is_published){
      return axiosInstance
      .patch('/intervention-categories?[where][id]='+ id, {published: is_published})
      .then(response => response.data)
      .catch(error_handler)
    ...
    saveCategoryTranslationProd (id) {
      ...
      // create fake id here
      return axiosInstance
        .get('/intervention-categories/to-production?id=' + id)
        .then(response => response.data)
        .catch(error_handler)
    },
    deleteCategoryTranslationProd (id) {
      // create fake id here
      return axiosInstance
        .delete('/intervention-categories/' + id + '/intervention-category-translation-prods')
        .then(response => response.data)
        .catch(error_handler)
    },
